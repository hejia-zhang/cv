...
\name{Hejia}{Zhang}
\address{3335 S Figueroa St. - 16 Los Angeles, CA 90007}
\mobile{(+86) 188-6810-2257}

\email{hejiazha@usc.edu}
%\homepage{www.pangu-robotics.com}
\github{hjzh4}
%\linkedin{posquit0}
%\skype{skypeid}
...
%\position{Software Engineer{\enskip\cdotp\enskip}Robotics Engineer} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{\today}{Hejia Zhang~~~·~~~Resume}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
...
\input{cv-sections/conferences}
\input{cv-sections/referees}
